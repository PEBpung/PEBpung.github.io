...
description: ML 모델을 서비스할 때 사용되는 강력한 오픈 소스 툴킷
author: Pebpung
pubDatetime: 2022-12-24T09:00:00
tags: [MLOps, Engineering]
---

### Summary

- `BentoML`은 머신러닝 모델의 개발, 관리, 배포를 쉽게 도와주는 오픈소스 프레임워크입니다
- Runner와 API 구조를 통해 간단하게 서빙 서버를 구현할 수 있습니다
- Docker, Yatai, bentoctl 등 다양한 배포 옵션을 제공합니다
...
BentoML의 개념을 이해했으니, 이제 실제로 모델을 패키징하는 과정을 살펴보겠습니다.
...
모델 저장이 완료되었다면, 이제 서비스 API를 구현할 차례입니다.
...
서비스 API까지 구현했다면, 이제 이를 하나의 패키지로 빌드해야 합니다.
...
Bento가 빌드되었다면, 다양한 환경에 배포할 수 있습니다.
...
이번 포스팅에서는 BentoML의 핵심 개념부터 모델 패키징, 서비스 API 구현, 빌드, 배포까지의 전체 과정을 살펴보았습니다.
