...
description: "실험 관리를 할 수 있는 W&B와 MLflow를 비교한 글입니다."
author: Pebpung
pubDatetime: 2022-06-01T09:00:00
tags: [MLOps, Engineering]
---

### Summary

- ML Pipeline에서 실험 관리의 중요성과 효율적인 구축 방법을 소개합니다
- Experiment Tracking Tool인 WandB와 Full Lifecycle Tool인 MLflow를 비교합니다
- 각 Tool의 장단점을 분석하여 용도에 맞는 선택 가이드를 제공합니다
...
지금까지 ML Pipeline의 구성 요소와 필요성에 대해 살펴보았습니다. 이제 본격적으로 두 가지 대표적인 실험 관리 도구를 비교해보겠습니다.
...
두 가지 유형의 Tool을 이해했으니, 이제 WandB와 MLflow의 구체적인 장단점을 비교해보겠습니다.
...
이번 포스팅에서는 ML Pipeline의 구성 요소를 살펴보고, WandB와 MLflow의 특징을 비교해보았습니다.

- 개별적인 모델 실험에 있어서 MLflow보다 **W&B**가 적합해 보입니다.
- MLflow는 전체적인 **lifecycle** 구성에 강력한 도구가 됩니다.

두 도구는 경쟁 관계라기보다 상호 보완적인 관계입니다. 실험 추적은 W&B로, 모델 관리와 배포는 MLflow로 사용하는 것이 효과적인 조합이 될 수 있습니다. 다음 포스팅에서는 MLflow의 구체적인 사용법을 다룰 예정입니다.