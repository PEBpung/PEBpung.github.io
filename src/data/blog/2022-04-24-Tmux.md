...
description: Tmux
author: Pebpung
pubDatetime: 2022-04-24T09:00:00
tags: [Engineering]
---
...
- tmux는 terminal multiplexer로, 여러 터미널을 독립적으로 사용할 수 있게 해주는 유틸리티입니다
- SSH 연결이 끊어져도 학습이 중단되지 않도록 세션을 유지할 수 있습니다
- Session, Window, Pane의 3가지 구성 요소로 효율적인 터미널 관리가 가능합니다
...
Tmux의 기본 구조를 이해했으니, 이제 실제 사용법을 살펴보겠습니다.
...
이번 포스팅에서는 tmux의 기본 개념과 주요 사용법을 살펴보았습니다. tmux를 활용하면 SSH 연결이 끊어져도 딥러닝 학습이 중단되지 않으며, 화면 분할을 통해 여러 작업을 동시에 모니터링할 수 있습니다. 서버에서 장시간 작업을 진행하시는 분들에게 tmux 사용을 강력히 추천드립니다.
