...
최근에 여러 환경에서 딥러닝 실험을 해야될 일이 있었습니다. 그때마다 가장 애먹는 부분이 바로 CUDA입니다. Hardware 마다 지원하는 driver도 다르고, driver마다 지원하는 cuda toolkit도 다릅니다. 또 pytorch를 사용할 때와, amp(Automatic Mixed Precision)를 사용할 때도 버전에 따라 될때도 있고 안될 때도 있습니다. (벌써 머리가 지끈지끈) 
